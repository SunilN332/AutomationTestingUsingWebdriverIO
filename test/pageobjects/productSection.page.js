...
class productSection extends Page {
    ...
    get shopptingCartBtn() {return $('//a[@data-test="shopping-cart-link"]')}
    get removeCartBth() {return $('//button[@name="remove"]')}
    get continueShopping() {return $('//button[@data-test="continue-shopping"]')}
    get checkoutBtn() {return $('//button[@class="btn btn_action btn_medium checkout_button "]')}
    ...
    get paymentInfo() {return $('//div[@data-test="payment-info-label"]')}
    get finistBtn() {return $('//button[@name="finish"]')}
    get backtoHomeBtn() {return $('//button[@data-test="back-to-products"]')}
